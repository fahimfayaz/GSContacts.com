    ...
    <div className={classes.root}>
      <Accordion>
        <AccordionSummary
          ...
          id="panel1a-header"
        >
          <Typography className={classes.heading}><span style={{display:"inline"}} width="50px"><img style={{display:"inline"}} src="https://res.cloudinary.com/american-international-university-bangladesh/image/upload/v1618301370/icons8-uk-news-50_tnflm9.png"/>{" "}<span style={{marginBottom:"30px!important"}}>About Australia</span></span></Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography className={classes.heading}><img style={{display:"inline"}} src="https://res.cloudinary.com/american-international-university-bangladesh/image/upload/v1618301369/icons8-passport-50_olt35v.png"/>{" "}Student Visa Requirements for the Australia </Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex,
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography className={classes.heading}><img style={{display:"inline"}} src="https://res.cloudinary.com/american-international-university-bangladesh/image/upload/v1618301369/icons8-study-50_bcyszh.png"/>{" "}Study Option in Australia</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex,
      ...
      <Accordion>
        <AccordionSummary
          ...
          id="panel2a-header"
        >
          <Typography className={classes.heading}><img style={{display:"inline"}} src="https://res.cloudinary.com/american-international-university-bangladesh/image/upload/v1618301369/icons8-payroll-50_dauuve.png"/>{" "}Employment prospects in the Australia</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse malesuada lacus ex,
