          ...
          <div className={splitClasses}>
            <div className="split-item">
              ...
              >
                ...
                <h1 className=" text-color-primary mt-0 mb-12">Step 1</h1>
                <p className="m-0">
                  Recruitment partners can search, compare, shortlist and apply
                  to courses to match student requirements in minutes
                </p>
              </div>
              <div
            ...
            <div className="split-item">
              ...
              >
                <div className="text-xxs text-color-primary fw-600 tt-u mb-8"></div>
                <h1 className="mt-0 mb-12 text-color-primary">STEP 2</h1>
                <p className="m-0">Upload all required student documents</p>
              </div>
              <div
                className={classNames(
                  "split-item-image center-content-mobile reveal-from-bottom",
            ...
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                Contacts Int reviews all documents & completes GTE verification
                </p>
              </div>
              <div
                className={classNames(
            ...
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                Contacts International lodges application with institution
                </p>
              </div>
              <div
                className={classNames(
            ...
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                GSP manages institutional correspondence and administrative needs.
                </p>
              </div>
              <div
                className={classNames(
            ...
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                Contacts International provides assistance and support on visa requirements
                </p>
              </div>
              <div
                className={classNames(
            ...
            <div className="split-item">
              ...
              >
                ...
                <p className="m-0">
                Recruitment partners receives commissions paid promptly after commencement date
                </p>
              </div>
              <div
                className={classNames(
