          ...
          <div className={tilesClasses}>
            ...
            <div className="tiles-item reveal-from-bottom">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="text-color-primary mt-0 mb-8">
                  Unique technology platform with processing, document management & CRM
                  </h4>
            ...
            <div className="tiles-item reveal-from-bottom">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="text-color-primary mt-0 mb-8">
                  Agent Toolkit – Access to agent marketing collateral
                  </h4>
                </div>
              </div>
            </div>
            ...
            <div className="tiles-item reveal-from-bottom">
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className="text-color-primary mt-0 mb-8">
                  Receive qualified student leads from GSP
                  </h4>
            ...
            >
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className=" text-color-primary mt-0 mb-8">
                  Access to over 27,000 courses and over 500 institutions
                  </h4>
            ...
            >
              <div className="tiles-item-inner">
                ...
                <div className="features-tiles-item-content">
                  <h4 className=" text-color-primary mt-0 mb-8">
                  Attractive commissions received from your enrolments
                  </h4>
